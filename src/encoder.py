...
class Encoder:
    def __init__(self, 
        ...
        self.transform, self.translator, self.face_recognizer = utils.get_all(self.model_name)
        self.align = align, 
    ...
    def encode(self, face, is_ir):
        ...
        if is_ir:
            ...
            if self.debug:
                    save_image(three_channeled_image, f"./three_channel_no_translate{_id}.png")
