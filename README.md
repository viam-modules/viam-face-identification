...
| `distance_metric`             | string | Optional     | `'cosine'`  | Distance metric used for face recognition. This attribute can be set to `'cosine'`, `'euclidean'` ( = norm L1, or Manhattan distance) and `'euclidean_l2'`. Default and recommanded is `'cosine'`.                                                                                                                                                                                                                                                                                                   |
